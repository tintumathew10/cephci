...
components = ["RADOS", "RBD", "RGW", "Ceph-Ansible", "Ceph-Mgr", "Ceph-Volume", "CephFS",
...
if __name__ == "__main__":
    ...
    base_url = config["cloud_instance"]["base_url"]
    user = config["cloud_instance"]["user"]
    api_key = config["cloud_instance"]["api_key"]
    ...
    template_id = tr_api.get_template_id(project_id, "Test Case (Steps)")
    print(template_id)
    ...
    field_configs = {
        ...
        "tier": {
            "type": "Dropdown",
            "options": {"format": "markdown", "items": "1, tier1\n2, tier2\n3, tier3\n4, tier4"}
        }
    }
            ...
            with open(file_path, 'r') as f:
                ...
                for case in cases:
                    tr_api.add_case(section_id, {
                        ...
                        "custom_tier": {"tier1": 1, "tier2": 2, "tier3": 3, "tier4": 4}.get(case.get("tier"), ""),
                        ...
                        "custom_automation_script": case["automation_script"],
